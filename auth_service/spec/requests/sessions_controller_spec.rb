...
RSpec.describe "SessionsControllers", type: :request do
  ...
  #     post registration_path, params: {registration: {username:"test7"}, authentication_method:1}
  #     # , authentication_method:1
  #     puts "my json"
  #     json = JSON.parse(response.body)
  #     puts json
  #
  #     # json1 = json <<  {authentication_method:1}
  #     puts json
  #     post callback_registration_path, params: JSON.parse(response.body)
  #     tempHash = {"authentication_method"=>"1"}
  #     jsnonew = JSON.pretty_generate(json << tempHash)
  #     puts jsnonew
  #     post session_path, params: {username:"test7", authentication_method:1}
  #
