...
RSpec.describe "FailingReasonsTypes", type: :request do
  ...
  describe "POST /create" do
    it 'creates and returns the failing reason type from given reason and component id' do
      ...
      post failing_reasons_types_path, params: {:reason => "damaged"}
      ...
      expected_json =  {"success"=>true, "result"=>{"id"=>@failing_reasons_type.id, "reason"=>"damaged", "created_at"=>@failing_reasons_type.created_at, "updated_at"=>@failing_reasons_type.updated_at}}
  ...
  describe "DELETE /destroy" do
    it 'destroys the failing reason type removes it from the lists of machine types and returns the destroy record details' do
      ...
      @failing_reasons_type = FailingReasonsType.create_record"damaged"
